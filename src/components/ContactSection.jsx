import { Linkedin, Mail, Phone, Twitter, Instagram, Twitch, MapPin, Send } from "lucide-react"
                        ...
                        <form className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea 
                                  ...
                                  name="message"
                                  required
                                  className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary reaize-none"
