...
const skills = [
    ...
    {name: "Linux/unix knowledge", level: 95, category: "Programming"},
    {name: "Shader Development", level: 70, category: "Programming"},
    
    // Software
    {name: "Houdini", level: 60, category: "Software"},
    {name: "Nuke", level: 80, category: "Software"},
    {name: "Unreal", level: 95, category: "Software"},
